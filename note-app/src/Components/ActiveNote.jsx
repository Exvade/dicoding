...
export default function ActiveNote({ cardData, onDelete, onArchive, searchQuery }) {
  const activeNotes = cardData
  ...
  return (
    <div className="mx-auto max-w-[80%] mt-20">
      <h2 className="font-semibold text-limeGreen text-3xl text-center mb-10">Catatan Aktif</h2>
          ...
          {activeNotes.map((note) => (
            <div key={note.id} className="border border-gray-400 flex flex-col p-4 m-2 w-[230px] rounded-lg justify-between">
              ...
              <div className="flex space-x-2 mt-4 justify-self-end">
                ...
                <button
                  className="bg-blue-500 text-white px-2 py-1 flex gap-[2px] justify-center items-center"
                  onClick={() => onArchive(note.id)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    <path fill="currentColor" d="m12 18l4-4l-1.4-1.4l-1.6 1.6V10h-2v4.2l-1.6-1.6L8 14zM5 8v11h14V8zm0 13q-.825 0-1.412-.587T3 19V6.525q0-.35.113-.675t.337-.6L4.7 3.725q.275-.35.687-.538T6.25 3h11.5q.45 0 .863.188t.687.537l1.25 1.525q.225.275.338.6t.112.675V19q0 .825-.587 1.413T19 21zm.4-15h13.2l-.85-1H6.25zm6.6 7.5"></path>
                  </svg>
                  <span>Arsip</span>
                </button>
              </div>
